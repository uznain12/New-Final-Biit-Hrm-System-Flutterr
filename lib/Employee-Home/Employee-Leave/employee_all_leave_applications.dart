...
class _EmployeeLeaveApplicationState extends State<EmployeeLeaveApplication> {
  ...
  Future<List<Leavewithusermodel>> fetchleaveapplication(int id) async {
    ...
    final response = await http.get(Uri.parse(
        'http://$ip/HrmPractise02/api/Leave/NewLeaveGet?uid=$id')); // is ma aik variable bnaya ha response ka name sa or phir get method ka through api ko hit kar rahay hn is ka data aik data variable ma store karway ga
