...
class AllRejectedLeaves extends StatefulWidget {
  const AllRejectedLeaves({
    super.key,
  });

  @override
  State<AllRejectedLeaves> createState() => _AllRejectedLeavesState();
}

class _AllRejectedLeavesState extends State<AllRejectedLeaves> {
  ...
  Future<List<Leavewithusermodel>> fetchleaveapplication() async {
    ...
    final response = await http.get(Uri.parse(
        'http://$ip/HrmPractise02/api/Leave/AllNewRejectedLeaveGet')); // is ma aik variable bnaya ha response ka name sa or phir get method ka through api ko hit kar rahay hn is ka data aik data variable ma store karway ga
