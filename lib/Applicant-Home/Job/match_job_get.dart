...
class BstMatchApplicantApplyJob extends StatefulWidget {
  ...
  @override
  State<BstMatchApplicantApplyJob> createState() =>
      _BstMatchApplicantApplyJobState();
}
...
class _BstMatchApplicantApplyJobState extends State<BstMatchApplicantApplyJob> {
  ...
  void initState() {
    super.initState();
    _widget = BstMatchApplicantApplyJob(uid: widget.uid);
  }
  ...
  Future<List<Jobmodel>> getjob(
    ...
    final response = await http.get(Uri.parse(
        'http://$ip/HrmPractise02/api/Job/ForBestMatchWithCheckfilterJobGet?uid=${widget.uid}'));
